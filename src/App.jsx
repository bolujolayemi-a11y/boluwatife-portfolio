      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-y-0 right-0 w-full max-w-xs z-50 p-6 flex flex-col border-l shadow-2xl bg-linear-to-br from-[#d8c7ff]/80 via-[#c574d3]/70 to-[#ff5fa2]/70 backdrop-blur-xl border-white/10"
          >
